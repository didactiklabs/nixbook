...
in
{
  ...
  programs.bash.loginShellInit = ''
    ...
    # Swap in the hardware-configuration.nix that includes fileSystems
    # This was pre-generated by the installer when disks were properly mounted
    # base.nix does not use disko, it expects fileSystems in hardware-configuration.nix
    echo "Activating final hardware configuration..."
    sudo cp /etc/nixos/hardware-configuration-final.nix /etc/nixos/hardware-configuration.nix
