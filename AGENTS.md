...
| `userConfig.nix`     | 241   | User management framework with mkUser helper, Home Manager integration, Qt theming (qt5ct/qt6ct installed system-wide with their launcher .desktop entries hidden via a NoDisplay=true postInstall override), Go dev environment                                                                   |
