  ...
  extensions = [
    {
      ...
      version = "0.0.1";
      sha256 = "sha256-z8n+zsbgm0CuVjA968S7hMek/P/TWGZTtq8YPQUiMlM=";
    }
    {
      name = "vscode-zonefile";
      publisher = "compilenix";
      version = "0.0.4";
      sha256 = "sha256-NRjR1mGpK1Rd4eF276Mu9u9wYXS6/pB/tZaDpOpLxaA=";
    }
    {
      name = "vscode-eslint";
      publisher = "dbaeumer";
    ...
    }
    {
      ...
      publisher = "golang";
      version = "0.52.2";
      sha256 = "sha256-8g+r4Mv06Bx1W3yAXWVbtz1B/gXPcRdmaV0tPkTP6Gk=";
    }
    {
      name = "nix-ide";
    ...
    }
    {
      ...
      publisher = "mousavian";
      version = "0.0.6";
      sha256 = "sha256-enQQX61y2n7GsZaw2ofkjdFPQ04Qrl4ypWwfpLyciUw=";
    }
    {
      name = "vscode-docker";
    ...
    }
    {
      ...
      publisher = "redhat";
      version = "1.21.0";
      sha256 = "sha256-55PBCTV6NJL+JVH+19vIoA5GKMDD8uB7z9OCOb+GjZM=";
    }
    {
      name = "jinjahtml";
    ...
    }
    {
      ...
      version = "12.17.0";
      sha256 = "sha256-pNLj/Hv0XbcB2dCBVJJDNd8omUV3KIRpgeoHOkPpz1M=";
    }
    {
      name = "jinja";
      publisher = "wholroyd";
    ...
    }
    {
      ...
      publisher = "task";
      version = "1.0.1";
      sha256 = "sha256-u96AGSvCCa5snx3iDlZ53VFwyBwuQUIZzwuWNMcK0cY=";
    }
  ];
}
